...
export default function LandingPage() {
  return (
      <div className="container relative flex flex-col min-h-screen px-6 py-8 ">
        <section className="flex items-center flex-1">
          <div className="flex flex-col w-full ">
            ...
            <p className="max-w-3xl mx-auto mt-6 text-lg text-center text-gray-700 dark:text-white md:text-xl">
              Somos una sociedad de capital laralara
              capital español, con casas de alquiler...
            </p>

            <div className="flex flex-col mt-8 space-y-3 sm:-mx-2 sm:flex-row sm:justify-center sm:space-y-0">
              <input id="email" type="text" className="px-6 py-3 text-gray-700 bg-white border rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring sm:mx-2" placeholder="Direcciòn de correo" />
            ...
            <p className="mt-8 text-center text-gray-700 dark:text-white text-md md:text-xl">No dude en contactarnos por cualquier duda...</p>
          </div>
        </section>
      </div>
  );
